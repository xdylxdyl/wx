...
@Entity
@Table(name = "puser_publics_relation")
public class PuserPublicsRelation implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6002123722583546880L;
