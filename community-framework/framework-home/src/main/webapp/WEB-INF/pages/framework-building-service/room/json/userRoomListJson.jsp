...
<json:property name="code" value="${code}"></json:property>
	...
	<json:object name="data">
		<json:array name="houses">
			<c:forEach items="${houses}" var="room">
				<json:object>
	            ...
	            <json:property name="address" value="${room.address}"></json:property>
		   
	        			
	               
	                    <json:property name="createBy" value="${room.createBy}"></json:property>
	           
	              		 <json:property name="decorateId" value="${room.decorateId}"></json:property>
