...
public class ExcelDocTest {
	...
	public void testParseExcelDoc() throws Exception {
		...
		CProject cProject = excelDesignDocParser.parseDesignDoc("document/qding-decorate.xls");
		// CProject cProject =
		// excelDesignDocParser.parseDesignDoc("document/test1.xls");
		Assert.assertNotNull(cProject);
		log.info("parse excel success ");

		/*
		 * log.info("generate core project"); boolean bc =
		 * codeGenerate.generateCoreProject(cProject); Assert.assertTrue(bc);
		...
		/*
		 * log.info("generate client project"); boolean bclient =
		 * codeGenerate.generateClientProject(cProject);
