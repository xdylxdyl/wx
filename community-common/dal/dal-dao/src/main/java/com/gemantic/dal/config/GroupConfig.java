...
public final class GroupConfig {
    ...
    public void close() {
        if (MapUtils.isNotEmpty(dataSourceItemMap)) {
            Collection<DataSource> dataSources = dataSourceItemMap.values();
    ...
    public DataSource getDataSource(String dataSourceName) {
        if (StringUtils.isNotEmpty(dataSourceName)) {
            return this.dataSourceItemMap.get(dataSourceName);
        } else {
            return null;
        }
    }
    ...
    public Map< String, DataSource > getDataSourceItemMap() {
