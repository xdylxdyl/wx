package com.gemantic.dal.cache.client;
...
public interface CacheClient {
    ...
    /**
     * 会在Cache中,打上删除的标记 Deletes an object from cache given cache key.
     * 
     * @param key
     ...
     * @return true, if the data was successfully stored
     */
    public abstract boolean set(String key, Object value, Long seconds);
