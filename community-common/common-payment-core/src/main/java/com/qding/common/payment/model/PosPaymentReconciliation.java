...
@Entity
@Table(name = "pos_payment_reconciliation")
public class PosPaymentReconciliation implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 8992027297394472960L;	
