 ...
 * under the License.    
 */
package scallop.sca.binding.jms.wireformat.jmsobject;
...
public class WireFormatJMSObject implements WireFormat {
    public static final QName WIRE_FORMAT_JMS_BYTES_QNAME = new QName(JMSBindingConstants.SCA10_SCALLOP_NS, "wireFormat.jmsObject");
